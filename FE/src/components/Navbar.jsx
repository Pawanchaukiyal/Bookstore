...
const navItems = (
  ...
  return (
    <>
    <div className={`max-w-screen-2xl container mx-auto z-50 md:px-20 px-4 fixed top-0 left-0 right-0 bg-white dark:bg-slate-800 dark:text-white ${
      sticky ? 
  ...
  <label className="flex outline-none px-3 py-2 rounded-md border items-center gap-2">
